...
![Ground News bias breakdown on a phone screen](../../assets/ground_news_bias.jpg){fig-alt="Screenshot of the Ground News app showing left-center-right bias breakdown for a news story" width="45%"}
...
- Have you shared something that later turned out false? What happened?
- If your side's meme is wrong but the underlying goal feels right, what should you do?
- How does permanent-crisis media make misinformation easier to believe?

# Next

## Next class

**September 23 — Module 2 Head Start Day: no class**
**September 28** Republic vs Democracy


## Reminders

- Use the head-start day for Module 2 work
- You should at a **minimum** *review the Module 2 Study Guide* and *watch the video in the required readings* before next Monday
- Stay current on Connect / journals / study guides as assigned
- Finish any unfinished Connect Assignments - they are already 15% off for late
